...
# Snowfox Nightly links folder name
default-bookmarks-nightly-heading = Snowfox Nightly Resources

# Nightly builds only, link title for https://blog.nightly.mozilla.org/
default-bookmarks-nightly-blog = Snowfox Nightly blog
